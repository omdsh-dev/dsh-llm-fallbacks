  ...
  return {
    ...
    fields: [
      ...
      },
      {
        ...
        hint: 'JSON array of model selectors; the last entry must be an official model (deepseek-official/deepseek-v4-flash, deepseek-official/deepseek-v4-pro, or deepseek-official/deepseek-flash).',
        hintDescriptions: { zh: '模型选择器 JSON 数组；末项必须是官方模型（deepseek-official/deepseek-v4-flash、deepseek-official/deepseek-v4-pro 或 deepseek-official/deepseek-flash）。', en: 'JSON array of model selectors; the last entry must be an official model (deepseek-official/deepseek-v4-flash, deepseek-official/deepseek-v4-pro, or deepseek-official/deepseek-flash).' },
        group: 'chain',
        kind: 'text',
