...
export const zh = {
  ...
  'chains.label': '降级链',
  'chains.hint': '键为角色名或模型选择器',
  'chains.tooltip': '键为 角色名 / provider/model / provider/*；条目为有序的 provider/model 或 provider/* 选择器。',
  'chains.key': '键',
  'chains.add': '添加链',
  'chains.remove': '删除该链',
  ...
  'roles.label': '角色',
  'roles.hint': '解析顺序：角色 → 规则 → 默认',
  'roles.tooltip': '解析顺序：agent.options.role → rules 顺序匹配 → default。',
  'roles.default': '默认角色',
  'roles.rules': '角色规则',
...
export const en = {
  ...
  'chains.hint': 'Keys are role names or model selectors',
  'chains.tooltip': 'Keys are role names / provider/model / provider/*; entries are ordered provider/model or provider/* selectors.',
  'chains.key': 'Key',
  ...
  'roles.label': 'Roles',
  'roles.hint': 'Resolution order: role → rules → default',
  'roles.tooltip': 'Resolution order: agent.options.role → rules in order → default.',
