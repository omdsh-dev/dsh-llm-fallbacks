...
export const zh = {
  ...
  'roles.label': '角色',
  'roles.hint': '解析顺序：规则 → 默认',
  'roles.tooltip': '解析顺序：rules 顺序匹配（origin/provider/model）→ default。',
  'roles.default': '默认角色',
  'roles.rules': '角色规则',
...
export const en = {
  ...
  'roles.label': 'Roles',
  'roles.hint': 'Resolution order: rules → default',
  'roles.tooltip': 'Resolution order: rules in order (origin/provider/model) → default.',
